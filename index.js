...
// the function "nestedFunction" is a closure and the varaible is in the lexical context.//
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(zooAnimals){
    ...
    zooAnimals.forEach((item) => {
      occupants.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`)
    });
    return occupants;
  }
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    ...
    zooAnimals.map((items) => {
      occupants.push(items.animal_name.toLowerCase())
    });
    return occupants;
  }
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    let occupants = zooAnimals.filter((item) =>{
  ...
  */
  ...
  function USApop(zooAnimals){
    let totalPop = zooAnimals.reduce((accumulator, item) =>{
